...
```bash
  msar inbox -h --u=<username> --p=<password> --o=<outputPath> --v=<val> --ignoreErrors --logRequests --commands --silent --headless --devtools --quit --pretty --concurrency=<concurrency> --rate=<rate> --logFilePath=<logFilePath> --stdoutLevel=<stdoutLevel> --fileLevel=<fileLevel> --opAccount=<example.1password.com> --opItem=<opItem> --opToken=<opToken> --serviceAccountToken=<Deprecated> --sso=<sso> --mfa=<mfa> --viewportWidth=<viewportWidth> --viewportHeight=<viewportHeight> --column=<column> --searchIn=<searchIn> url csv
```
